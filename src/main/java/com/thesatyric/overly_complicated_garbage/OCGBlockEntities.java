...
public class OCGBlockEntities {
    ...
    public static final BlockEntityType<SuspiciousGarbageBlockEntity> SUSPICIOUS_GARBAGE_BLOCK_ENTITY =
            register("suspicious_garbage_block", SuspiciousGarbageBlockEntity::new, OCGarbageBlocks.SUSPICIOUS_GARBAGE_BLOCK);
